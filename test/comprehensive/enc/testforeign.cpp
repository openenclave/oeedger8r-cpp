...
template <typename F> static void test_ocall(F f, size_t count) {
...
void test_foreign_edl_ocalls() {
  ...
  test_ocall([](my_type1 *a1, my_type1 *a2,
                my_type1 *a3) { return ocall_foreign_ptr_4(a1, a2, a3, 5); },
             5);

  test_ocall([](my_type1 *a1, my_type1 *a2,
                my_type1 *a3) { return ocall_foreign_ptr_5(a1, a2, a3, 64); },
             64 / sizeof(my_type1));
  ...
  test_ocall([](my_type1 *a1, my_type1 *a2,
                my_type1 *a3) { return ocall_foreign_isptr_4(a1, a2, a3, 5); },
             5);

  test_ocall([](my_type1 *a1, my_type1 *a2,
                my_type1 *a3) { return ocall_foreign_isptr_5(a1, a2, a3, 64); },
             64 / sizeof(my_type1));
...
void ecall_foreign_ptr_4(my_type1 *arg1, my_type1 *arg2, my_type1 *arg3,
                         size_t count) {
  test_args(arg1, arg2, arg3, count);
}

void ecall_foreign_ptr_5(my_type1 *arg1, my_type1 *arg2, my_type1 *arg3,
                         size_t size) {
...
void ecall_foreign_isptr_4(my_type2 arg1, my_type2 arg2, my_type2 arg3,
                           size_t count) {
  test_args(arg1, arg2, arg3, count);
}

void ecall_foreign_isptr_5(my_type2 arg1, my_type2 arg2, my_type2 arg3,
                           size_t size) {
  test_args(arg1, arg2, arg3, size / sizeof(my_type1));
}
